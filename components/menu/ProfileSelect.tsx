...
type ProfileSelectProps = {
   ...
   *  browsing its local worlds through the account home's local-worlds door. */
  onBackToAccount?: () => void;
  /** Return to the welcome gate — offered to logged-out visitors instead
   *  (exactly one of the two "back" doors renders). */
  onBackToWelcome?: () => void;
};

/** The local (browser) profiles menu: pick, create, rename or delete one.
 *  Purely local — sign-in lives on the welcome gate's AuthScreen, not here. */
export default function ProfileSelect({ onPlay, onBackToAccount, onBackToWelcome }: ProfileSelectProps) {
